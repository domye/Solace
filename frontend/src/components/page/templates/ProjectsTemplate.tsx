	...
	return (
		<div className="space-y-4 md:space-y-6 fade-in-up">
			...
			{activeProjects.length > 0 && (
				<div className="card-base p-4 md:p-6 lg:p-8">
					<h2 className="text-90 text-lg md:text-xl font-bold mb-4 md:mb-6 flex items-center gap-2">
			...
			{archivedProjects.length > 0 && (
				<div className="card-base p-4 md:p-6 lg:p-8">
					<h2 className="text-90 text-lg md:text-xl font-bold mb-4 md:mb-6 flex items-center gap-2 text-50">
						<SafeIcon icon="material-symbols:archive-outline-rounded" />
						历史项目
					</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 opacity-60">
			...
			{!frontmatter.projects?.length && !markdown && (
				<div className="card-base p-4 md:p-6 lg:p-8 text-center text-50">暂无项目</div>
			)}
		</div>
	);
}
