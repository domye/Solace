...
export const PostCardSkeleton = memo(function PostCardSkeleton({
	...
	return (
		<>
			...
			{/* 桌面端骨架 */}
			<div className="hidden md:flex card-base flex-col w-full rounded-[var(--radius-large)] overflow-hidden relative">
				{/* 内容区域 */}
				<div
              ...
              rounded-xl overflow-hidden"
				...
				{/* 进入按钮骨架（无封面时） */}
				{!hasCover && (
					<div className="skeleton !hidden md:!flex w-[3.25rem] absolute right-3 top-3 bottom-3 rounded-xl"></div>
				)}
			</div>
